...
namespace Data.DAL
{
    ...
    {
        string conString = "Server=DESKTOP-DMS4347\\SQLEXPRESS01;Database=AdoNetAB204;Trusted_Connection=true;Integrated Security=true;TrustServerCertificate=true;";
